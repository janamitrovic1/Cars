    ...
    <div className="max-w-md mx-auto mt-8 p-6 border rounded-md shadow-lg">
      ...
      <form onSubmit={handleSubmit}>
        ...
        <div className="mb-4">
          <label
            className={`block text-sm font-medium ${
              errors.BrTelefona ? "text-red-500" : ""
            }`}
          >
            Phone number
          </label>
          <input
            ...
            name="BrTelefona"
            className={`w-full px-3 py-2 mt-1 border ${
              errors.BrTelefona ? "border-red-500" : "border-gray-300"
            } bg-gray-50 text-gray-800 rounded-md`}
            value={formData.BrTelefona}
            onChange={(e) =>
              setFormData({ ...formData, BrTelefona: e.target.value })
            }
          />
          {errors.BrTelefona && (
